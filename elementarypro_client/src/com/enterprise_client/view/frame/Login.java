package com.enterprise_client.view.frame;
...
import com.enterprise_client.action.LoginAction;
import com.enterprise_client.action.WindAction;
import com.enterprise_client.util.CommonComponent;
import com.enterprise_client.util.GBC;
import com.enterprise_client.util.ImagePanel;
	...
	public JPanel createCenJPanel() {
		...
		if (cenJPanel == null) {
			...
			cenJPanel.add(cancel = CommonComponent.buildButton(null, null,
					new ImageIcon("image/icon/退出.png"), null, null, null, null, true), new GBC(1, 13)
			.setInset(10));
