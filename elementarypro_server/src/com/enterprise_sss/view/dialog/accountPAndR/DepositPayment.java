 ...
 *
 */
public class DepositPayment extends BaseAccount {
	public DepositPayment(String title,String tableTitle1, TableVO tvo1,String tableTitle2, TableVO tvo2){
	...
	public void initAction() {
		...
		DepositPaymentAction dra=new DepositPaymentAction(this);
		//给按钮添加监听事件
